...
describe "Chickens::DuckFilter" do

  it "allows objects that respond to a single specified method" do
    f = Chickens::DuckFilter.new(:methods => [:length])
  ...
  it "considers nil to be invalid" do
    f = Chickens::DuckFilter.new(:nils => false)
  ...
  it "considers nil to be valid" do
    f = Chickens::DuckFilter.new(:nils => true)
    filtered, errors = f.filter(nil)
    assert_equal nil, filtered
    assert_equal nil, errors
  end
